...
export const kochiDepth = {
  ...
  'web-design-company-in-kochi': {
    ...
    extraFaqs: [
      ...
      { question: 'How much does a website cost in Kochi?', answer: 'Every engagement is scoped individually after a discovery session, from the outcome you need and the work involved, and quoted before anything starts. Ad spend, where it applies, is separate and paid directly to the platforms, and we will say plainly if the budget on the table is too small to produce a usable result.' },
  ...
  'mobile-app-development-company-in-kochi': {
    ...
    extraFaqs: [
      ...
      { question: 'How much does app development cost in Kochi?', answer: 'Every engagement is scoped individually after a discovery session, from the outcome you need and the work involved, and quoted before anything starts. Ad spend, where it applies, is separate and paid directly to the platforms, and we will say plainly if the budget on the table is too small to produce a usable result.' },
  ...
  'it-company-in-kochi': {
    ...
    specs: [
      ...
      ['ERP or CRM implementation', '6 to 20 weeks'],
      ['Custom application', '8 to 16 weeks'],
      ['Integration project', '3 to 8 weeks'],
      ['Website or e-commerce', '3 to 14 weeks'],
    ...
    extraFaqs: [
      ...
      { question: 'What does managed support cost?', answer: 'Scope drives the number, so the honest answer comes after a short discovery rather than before it. What we commit to in advance is that the quote is fixed for the agreed scope, that there are no surprise extras, and that we tell you when a cheaper route would serve you better.' },
      ...
      { question: 'What does a systems audit cost and what do we get?', answer: 'You get a system map, a trace of how orders, invoices and customers move, a risk review of hosting, backups, security and compliance, and a costed roadmap of what to replace, integrate and leave alone. It is yours whether or not we do the work.' },
  ...
  'ecommerce-website-development-company-in-kochi': {
    ...
    specs: [
      ...
      ['Headless or custom platform', '10 to 16 weeks'],
      ['Marketplace and ONDC integration', '2 to 5 weeks'],
      ['Migration from an existing store', '4 to 10 weeks'],
    ...
    extraFaqs: [
      ...
      { question: 'How much does an e-commerce website cost in Kochi?', answer: 'Every engagement is scoped individually after a discovery session, from the outcome you need and the work involved, and quoted before anything starts. Ad spend, where it applies, is separate and paid directly to the platforms, and we will say plainly if the budget on the table is too small to produce a usable result.' },
  ...
  'ui-ux-design-company-in-kochi': {
    ...
    extraFaqs: [
      ...
      { question: 'How much does UI/UX design cost in Kochi?', answer: 'Scope drives the number, so the honest answer comes after a short discovery rather than before it. What we commit to in advance is that the quote is fixed for the agreed scope, that there are no surprise extras, and that we tell you when a cheaper route would serve you better.' },
