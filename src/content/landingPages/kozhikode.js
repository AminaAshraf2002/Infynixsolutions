...
//
// "Calicut" is still the more common spelling in older citations and among many
// searchers, so every page here carries both terms naturally in the copy.

export const kozhikodePages = [
  {
    slug: 'digital-marketing-agency-in-kozhikode',
    city: 'Kozhikode',
    cityAlt: 'Calicut',
    region: 'Kerala',
    ...
    intro: [
      ...
      'We work with Kozhikode retailers, textile and jewellery businesses, hospitals and clinics, educational institutions and hospitality operators from our Kochi base, with shoot days and meetings planned in Kozhikode.',
    ],
    servicesHeading: 'Digital Marketing Services for Kozhikode Businesses',
    services: [
      {
      ...
      },
      {
        ...
        desc: 'For businesses with a physical Kozhikode location, we optimise and manage the profile that drives your local map-pack visibility.',
      },
      {
        name: 'Google & Meta Advertising',
        desc: 'Geo-targeted campaigns across the Kozhikode district with Malayalam creative and conversion tracking into your CRM.',
      },
      {
        name: 'Malayalam Content & Social',
        desc: 'Reels, posts and campaigns written in Malabar Malayalam, which reads differently from the Ernakulam register and audiences notice.',
      },
      {
      ...
      },
      {
        ...
        desc: 'WhatsApp Business API journeys and automated follow-up, since it is where most Malabar enquiries actually convert.',
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, if you have a genuine physical location in Kozhikode. The map pack ranks businesses by proximity to the searcher, so it is your address that matters, not ours. We optimise and manage your Google Business Profile, citations and review programme to compete in local results.',
      },
      {
        question: 'How do you handle Malayalam content for Malabar audiences?',
        answer:
          'The Malayalam used in Kozhikode differs in register and vocabulary from Ernakulam Malayalam, and audiences pick up on copy that sounds imported. We write Malabar-appropriate creative and test it against the local audience rather than reusing central Kerala assets.',
      },
      {
...

  {
    ...
    services: [
      {
        name: 'Local SEO for Kozhikode',
        desc: 'Google Business Profile optimisation, Malabar directory citations, NAP consistency and review generation for map-pack visibility.',
      },
      {
      ...
      },
      {
        ...
        desc: 'Service and location pages plus supporting content in English and Malayalam, mapped to real search intent.',
      },
      {
        name: 'Schema Markup',
        desc: 'LocalBusiness, Service and FAQ structured data so search engines can parse who you are, what you do and where you operate.',
      },
      {
    ...
    localBody: [
      'Competition for Kozhikode search terms is materially thinner than for equivalent Kochi or state-level terms. Fewer local businesses invest seriously in SEO, and those that do often stop at a Google Business Profile listing.',
      'For a Kozhikode business willing to do the technical work, publish genuinely useful content and build reviews consistently, page-one visibility is a realistic 4-to-6-month objective rather than the year-plus campaign the same terms would demand in Ernakulam.',
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Considerably less competitive than Kochi or state-level Kerala terms. Fewer local businesses invest in SEO, and those that do frequently stop at basic listings. Page one for local service terms is a realistic 4-to-6-month goal with consistent execution.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Very. Malabar buying culture is reputation-led, and review count and recency influence both map-pack ranking and click-through. A systematic review programme is usually the highest-return single action available to a Kozhikode business.',
      },
      {
  ...
  {
    slug: 'software-development-company-in-kozhikode',
    city: 'Kozhikode',
    cityAlt: 'Calicut',
    region: 'Kerala',
    ...
    services: [
      {
        ...
        desc: 'Order management, inventory, billing and operations platforms designed around how your business actually runs.',
      },
      {
        name: 'CRM & ERP Implementation',
        desc: 'Custom or tailored systems giving multi-branch Malabar businesses one consistent view across locations.',
      },
      {
        name: 'E-Commerce Platforms',
        desc: 'Online storefronts with Indian payment gateways, logistics integration and GCC shipping for Gulf-market sellers.',
      },
      {
        name: 'Mobile App Development',
        desc: 'Customer and field-team apps in React Native or Flutter, built with the backend they depend on.',
      },
      {
        name: 'Systems Integration',
        desc: 'Connecting Tally, inventory, e-commerce and logistics so data flows once instead of being re-keyed between systems.',
      },
      {
        name: 'AI & Process Automation',
        desc: 'Automating invoice processing, order routing and customer enquiries where the manual hours are genuinely measurable.',
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. Tally integration is one of the most common requests from Kerala businesses. We build sync layers so sales, inventory and purchase data flow between your new system and Tally without duplicate entry, and the same applies to most existing accounting and inventory tools.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. Many Kozhikode businesses run parallel Gulf operations, and we build multi-currency, multi-location systems accordingly. We have delivery experience with UAE clients and understand the compliance and VAT requirements involved.',
      },
      {
        question: 'How do we start?',
        answer:
          'With a discovery conversation, then a paid discovery phase of two to four weeks producing a technical assessment, scoped roadmap and fixed phase-one estimate. That output is yours regardless of whether you continue with us.',
      },
    ],
    related: [
  ...
  {
    slug: 'web-design-company-in-kozhikode',
    city: 'Kozhikode',
    cityAlt: 'Calicut',
    region: 'Kerala',
    ...
    intro: [
      ...
      'We build for textile and jewellery retailers, food and spice exporters, hospitals and clinics, educational institutions and hospitality operators across the district.',
    ],
    servicesHeading: 'Website Services for Kozhikode Businesses',
    services: [
      {
        name: 'Business & Retail Websites',
        desc: 'Fast, credible sites with the search foundations and enquiry paths built in from the first wireframe.',
      },
      {
        name: 'E-Commerce with Gulf Shipping',
        desc: 'Storefronts configured for both Indian and GCC delivery, with multi-currency pricing and the logistics integrations Malabar exporters actually need.',
      },
      {
        name: 'Kozhikode & Calicut Optimisation',
        desc: 'On-page structure targeting both city spellings, since your customers and Gulf-based buyers use them interchangeably.',
      },
      {
        name: 'Malayalam & English Builds',
        desc: 'Bilingual sites with correct hreflang and proper Malayalam typography, so both versions rank rather than competing.',
      },
      {
        name: 'Performance Optimisation',
        desc: 'Core Web Vitals work tested on mid-range Android over mobile data, which is how nearly all your visitors will arrive.',
      },
      {
        name: 'Redesign & Migration',
        desc: 'Rebuilds with proper redirect mapping so an established Kozhikode business keeps the search equity it already has.',
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, and for many Kozhikode retailers and exporters that is the point of the store. We configure multi-currency pricing, GCC shipping zones, customs-appropriate product data and payment methods that work for buyers in the UAE, Saudi Arabia and Qatar.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes, for kickoff meetings, photography and content shoots, and milestone reviews. Our office is in Kochi, roughly three hours away, and we plan visits into the project rather than treating them as exceptional.',
      },
      {
        question: 'How long does it take?',
        answer:
          'Typically 4 to 6 weeks for a business site and 8 to 14 weeks for e-commerce. The realistic constraint is how quickly product information, photography and approvals come back from your side.',
      },
    ],
    related: [
      'seo-company-in-kozhikode',
  ...
  {
    slug: 'mobile-app-development-company-in-kozhikode',
    city: 'Kozhikode',
    cityAlt: 'Calicut',
    region: 'Kerala',
    ...
    services: [
      ...
      },
      {
        ...
        desc: 'Distributor and retailer ordering platforms replacing phone-and-WhatsApp order taking with something that reconciles against stock.',
      },
      {
        name: 'Customer Apps',
        desc: 'Booking, loyalty and account apps for retail, healthcare and hospitality businesses with genuine repeat usage.',
      },
      {
        name: 'Cross-Platform Development',
        desc: 'React Native and Flutter builds sharing one codebase across iOS and Android, materially reducing build and maintenance cost.',
      },
      {
        name: 'Backend & Integrations',
        desc: 'APIs, sync logic and integration with Tally, inventory and logistics systems you already run.',
      },
      {
        name: 'Launch & Support',
        desc: 'Store submission, review handling, crash monitoring and iteration based on how the app is actually used after launch.',
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. Tally integration is among the most common requests we get from Kerala businesses. We build sync layers so orders, stock and invoices flow between the app and your existing systems without duplicate entry.',
      },
      {
        question: 'Do you have an office in Kozhikode?',
        answer:
      ...
      },
      {
        question: 'How long does it take?',
        answer:
          'A cross-platform MVP is typically 10 to 16 weeks including design, development, testing and store submission. Internal-only apps distributed outside the public stores can move faster since they skip store review.',
      },
    ],
    related: [
      'software-development-company-in-kozhikode',
